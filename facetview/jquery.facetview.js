...
(function($){
    $.fn.facetview = function(options) {
        ...
        var defaults = {
            "config_file":false,
            //"default_filters":["location_s__s", "science_keywords_s"],
            "default_filters":["location_s__s", "science_keywords_s"],
            ...
            "footer_content":"",
            "show_advanced":false,
            "search_url":"http://localhost:8983/solr/query?",
            "search_index":"solr",
            "default_url_params":{
                            "wt":"json",
                            "facet.mincount":1,
...
//            jQuery('body').prepend('<div id="facetview_theurl">' + theurl + '</div>');
        ...
        thefacetview += '</div>' + '<div class="facetview_column">' +
            '<div id="facetview_search"><h5>SEARCH</h5>' +
            '<span class="facetview_green">Find </span>' +
            '<input class="input-medium" type="text" id="facetview_freetext" />' +
